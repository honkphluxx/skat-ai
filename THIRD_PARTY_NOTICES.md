...
| [SkatZero](https://github.com/Jimboom7/SkatZero) | pinned checkout, models included | MIT License | The third outside opponent, a self-play reinforcement learner, via `tools/skatzero-bot.py`. Cloned into `third_party/skatzero`, run through onnxruntime, not redistributed here. Nothing upstream is changed; the driver is a file of ours. |
...
and the SkatZero driver uses NumPy and onnxruntime; all are expected in the
environment. None is part of any build and no part of them is redistributed here.
